...
set LJDLLNAME=luajit_debug_windows_64.dll
set LJLIBNAME=luajit_debug_windows_64.lib
set LJPDBNAME=luajit_debug_windows_64.pdb
set LJEXENAME=luajit_debug_windows_64.exe
