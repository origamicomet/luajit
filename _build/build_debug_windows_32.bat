...
set LJDLLNAME=luajit_debug_windows_32.dll
set LJLIBNAME=luajit_debug_windows_32.lib
set LJPDBNAME=luajit_debug_windows_32.pdb
set LJEXENAME=luajit_debug_windows_32.exe
