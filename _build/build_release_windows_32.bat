...
set LJDLLNAME=luajit_release_windows_32.dll
set LJLIBNAME=luajit_release_windows_32.lib
set LJPDBNAME=luajit_release_windows_32.pdb
set LJEXENAME=luajit_release_windows_32.exe
